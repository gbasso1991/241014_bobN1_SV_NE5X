...
owon.set_channel(channel=CH2,range='5v',offset=0.5,probe='1x',coupling=AC)
...
promediador_señales(freq=20,num_prom=20,
                    name='300kHz_150dA_100Mss_bobN1C1',
                    plot_range=0.1)
...
#     x,y=frame.ch1.x()-frame.ch1.x()[0],frame.ch1.y()
#     g,h=frame.ch2.x()-frame.ch2.x()[0],frame.ch2.y()
#     iter_plotter(x,y,g,h,indx,plot_range_CH1=0.1,plot_range_CH2=2)
