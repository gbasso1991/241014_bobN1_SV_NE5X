...
#%% C1  en LN2 300 57
resultados_C1LN2_300 = glob(os.path.join('./C1_LN2', '**', '*resultados*.txt'),recursive=True)
resultados_C1LN2_300.sort()
meta_C1LN2_1,files_1,time_1,T_300_C1LN2_1,Mr_300_C1LN2_1,Hc_300_C1LN2_1,campo_max_1,mag_max_1,xi_M_0_1,frecuencia_fund_1,magnitud_fund_0_1,dphi_fem_0_1,SAR_300_C1LN2_1,tau_300_C1LN2_1,N1 = lector_resultados(resultados_C1LN2_300[0])
meta_C1LN2_2,files_2,time_2,T_300_C1LN2_2,Mr_300_C1LN2_2,Hc_300_C1LN2_2,campo_max_2,mag_max_2,xi_M_0_2,frecuencia_fund_2,magnitud_fund_0_2,dphi_fem_0_2,SAR_300_C1LN2_2,tau_300_C1LN2_2,N2 = lector_resultados(resultados_C1LN2_300[1])
meta_C1LN2_3,files_3,time_3,T_300_C1LN2_3,Mr_300_C1LN2_3,Hc_300_C1LN2_3,campo_max_3,mag_max_3,xi_M_0_3,frecuencia_fund_3,magnitud_fund_0_3,dphi_fem_0_3,SAR_300_C1LN2_3,tau_300_C1LN2_3,N3 = lector_resultados(resultados_C1LN2_300[2])
meta_C1LN2_4,files_4,time_4,T_300_C1LN2_4,Mr_300_C1LN2_4,Hc_300_C1LN2_4,campo_max_4,mag_max_4,xi_M_0_4,frecuencia_fund_4,magnitud_fund_0_4,dphi_fem_0_4,SAR_300_C1LN2_4,tau_300_C1LN2_4,N3 = lector_resultados(resultados_C1LN2_300[3])

#% Tau vs Temp
fig,((ax,ax2),(ax3,ax4))= plt.subplots(nrows=2,ncols=2,figsize=(12,8),constrained_layout=True,sharex=True)

ax.plot(T_300_C1LN2_1,tau_300_C1LN2_1,'.-',label='1')
ax.plot(T_300_C1LN2_2,tau_300_C1LN2_2,'.-',label='2')
ax.plot(T_300_C1LN2_3,tau_300_C1LN2_3,'.-',label='3')
ax.plot(T_300_C1LN2_4,tau_300_C1LN2_4,'.-',label='4')
ax.set_title(r'$\tau$')
ax.set_ylabel(r'$\tau$ (s)')

ax2.plot(T_300_C1LN2_1,SAR_300_C1LN2_1,'.-',label='1')
ax2.plot(T_300_C1LN2_2,SAR_300_C1LN2_2,'.-',label='2')
ax2.plot(T_300_C1LN2_3,SAR_300_C1LN2_3,'.-',label='3')
ax2.plot(T_300_C1LN2_4,SAR_300_C1LN2_4,'.-',label='4')
ax2.set_title('SAR')
ax2.set_ylabel('SAR (W/g)')

ax3.plot(T_300_C1LN2_1,Mr_300_C1LN2_1,'.-',label='1')
ax3.plot(T_300_C1LN2_2,Mr_300_C1LN2_2,'.-',label='2')
ax3.plot(T_300_C1LN2_3,Mr_300_C1LN2_3,'.-',label='3')
ax3.plot(T_300_C1LN2_4,Mr_300_C1LN2_4,'.-',label='4')
ax3.set_title('M$_R$')
ax3.set_ylabel('M$_R$ (A/m)')

ax4.plot(T_300_C1LN2_1,Hc_300_C1LN2_1,'.-',label='1')
ax4.plot(T_300_C1LN2_2,Hc_300_C1LN2_2,'.-',label='2')
ax4.plot(T_300_C1LN2_3,Hc_300_C1LN2_3,'.-',label='3')
ax4.plot(T_300_C1LN2_4,Hc_300_C1LN2_4,'.-',label='4')
ax4.set_title('H$_C$')
ax4.set_ylabel('H$_C$  (kA/m)')
...
ax3.set_xlabel('T (°C)')
ax4.set_xlabel('T (°C)')
plt.suptitle('Comparativa C1LN2 - NE5X - 300 kHz 57 kA/m')
plt.savefig('C1LN2_300_57_NE5X_comparativa.png',dpi=300)
plt.show()
...
temperature_ranges_1 = [(i, i + 1) for i in np.arange(-170,-10,1)]
...
# C1LN2
indices_temp_300_150_C1LN2_1 = get_indices_by_range(T_300_C1LN2_1,temperature_ranges_all)
indices_temp_300_150_C1LN2_2 = get_indices_by_range(T_300_C1LN2_2,temperature_ranges_all)
indices_temp_300_150_C1LN2_3 = get_indices_by_range(T_300_C1LN2_3,temperature_ranges_all)
indices_temp_300_150_C1LN2_4 = get_indices_by_range(T_300_C1LN2_4,temperature_ranges_all)
# Lista de listas de índices por archivo de temperatura
indices_by_temp = [indices_temp_300_150_C1LN2_2, indices_temp_300_150_C1LN2_3, indices_temp_300_150_C1LN2_4]
...
for i in range(len(temperature_ranges_all)):
    # Promedio para T_300
    Temp_300_C1LN2.append(np.mean(np.concatenate([T_300_C1LN2_2[indices_temp_300_150_C1LN2_2[i]],
                                            T_300_C1LN2_3[indices_temp_300_150_C1LN2_3[i]],
                                            T_300_C1LN2_4[indices_temp_300_150_C1LN2_4[i]]])))

    Temp_300_C1LN2_err.append(np.std(np.concatenate([T_300_C1LN2_2[indices_temp_300_150_C1LN2_2[i]],
                                                T_300_C1LN2_3[indices_temp_300_150_C1LN2_3[i]],
                                                T_300_C1LN2_4[indices_temp_300_150_C1LN2_4[i]]]))),

    tau_300_C1LN2.append(np.mean(np.concatenate([tau_300_C1LN2_2[indices_temp_300_150_C1LN2_2[i]],
                                           tau_300_C1LN2_3[indices_temp_300_150_C1LN2_3[i]],
                                           tau_300_C1LN2_4[indices_temp_300_150_C1LN2_4[i]]])))

    tau_300_C1LN2_err.append(np.std(np.concatenate([tau_300_C1LN2_2[indices_temp_300_150_C1LN2_2[i]],
                                                 tau_300_C1LN2_3[indices_temp_300_150_C1LN2_3[i]],
                                            tau_300_C1LN2_4[indices_temp_300_150_C1LN2_4[i]]])))

#remuevo elementos nan
Temp_300_C1LN2 = [i for i in Temp_300_C1LN2 if ~np.isnan(i)]
Temp_300_C1LN2_err = [i for i in Temp_300_C1LN2_err if ~np.isnan(i)]
tau_300_C1LN2 = [i for i in tau_300_C1LN2 if ~np.isnan(i)]
tau_300_C1LN2_err = [i for i in tau_300_C1LN2_err if ~np.isnan(i)]
...
ax.set_title('NE5X - C1 - Aq',loc='left')
ax.plot(T_300_C0_1,tau_300_C0_1,'.-',lw=0.7,label='C0')
ax.plot(T_300_C0_2,tau_300_C0_2,'.-',lw=0.7,label='C0')
ax.plot(T_300_C0_3,tau_300_C0_3,'.-',lw=0.7,label='C0')
ax.plot(T_300_C0_4,tau_300_C0_4,'.-',lw=0.7,label='C0')

ax2.set_title('NE5X - C1 - SV',loc='left')

ax2.plot(T_300_C1_1,tau_300_C1_1,'.-',lw=0.7,label='C1')
ax2.plot(T_300_C1_2,tau_300_C1_2,'.-',lw=0.7,label='C1')
ax2.plot(T_300_C1_3,tau_300_C1_3,'.-',lw=0.7,label='C1')
ax2.plot(T_300_C1_4,tau_300_C1_4,'.-',lw=0.7,label='C1')



ax2.set_xlabel('T (°C)')
ax.legend(title=f'''C0 = {meta_C0_1["Concentracion g/m^3"]/1e3:.1f} g/L''',ncol=2)
ax2.legend(title=f'''C1 = {meta_C1_2["Concentracion g/m^3"]/1e3:.1f} g/L''',ncol=2)
...
plt.savefig('comparativa_all_NE5X_Aq_SV_loc_fallas.png',dpi=300)

#%% comparativa promedios
...
ax.legend(title=f'C0 = {meta_C0_1["Concentracion g/m^3"]/1e3:.1f} g/L    C1 = {meta_C1_2["Concentracion g/m^3"]/1e3:.1f} g/L',ncol=2)
ax.grid()
ax.set_xlabel('T (°C)')
ax.set_ylabel(r'$\tau$ (s)')
...
#%% comparativa promedios C1 y C!LN2
fig,ax=plt.subplots(nrows=1,figsize=(12,5),constrained_layout=True)
ax.errorbar(x=Temp_300_C1,y=tau_300_C1,xerr=Temp_300_C1_err,yerr=tau_300_C1_err,fmt='.-',capsize=3,label='C1 (SV)')
ax.errorbar(x=Temp_300_C1LN2,y=tau_300_C1LN2,xerr=Temp_300_C1LN2_err,yerr=tau_300_C1LN2_err,fmt='.-',capsize=3,label='C1LN2 (aq)')
# ax.errorbar(x=Temp_300_C2,y=tau_300_C2,xerr=Temp_300_C2_err,yerr=tau_300_C2_err,fmt='.-',capsize=3,label='C2 (SV)')
...
#%%
#%% comparativa all C1 y C1LN2
fig,ax=plt.subplots(nrows=1,figsize=(12,5),constrained_layout=True)
ax.plot(T_300_C1_1,tau_300_C1_1,'.-',lw=0.7,label='C1')
ax.plot(T_300_C1_2,tau_300_C1_2,'.-',lw=0.7,label='C1')
ax.plot(T_300_C1_3,tau_300_C1_3,'.-',lw=0.7,label='C1')
ax.plot(T_300_C1_4,tau_300_C1_4,'.-',lw=0.7,label='C1')

ax.plot(T_300_C1LN2_1,tau_300_C1LN2_1,'.-',lw=0.7,label='C1LN2')
ax.plot(T_300_C1LN2_2,tau_300_C1LN2_2,'.-',lw=0.7,label='C1LN2')
ax.plot(T_300_C1LN2_3,tau_300_C1LN2_3,'.-',lw=0.7,label='C1LN2')
ax.plot(T_300_C1LN2_4,tau_300_C1LN2_4,'.-',lw=0.7,label='C1LN2')
...
ax.set_title(f'$\\tau$ vs T\nNE5X\n$f$ = 300 kHz      $H_0$ = 57 kA/m')
plt.savefig('comparativa_NE5X_Aq_SV_loc_fallas.png',dpi=300)
plt.savefig('comparativa_promedios_NE5X_SV_LN2_LF.png',dpi=300)
#%%
